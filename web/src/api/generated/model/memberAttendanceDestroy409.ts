 ...
 */
import type { MemberAttendanceDestroy409Code } from "./memberAttendanceDestroy409Code";
import type { MemberAttendanceDestroy409ErrorsItem } from "./memberAttendanceDestroy409ErrorsItem";

export type MemberAttendanceDestroy409 = {
  ...
  code: MemberAttendanceDestroy409Code;
  /** Always empty for this status; present so every problem has the same shape. */
  errors: MemberAttendanceDestroy409ErrorsItem[];
