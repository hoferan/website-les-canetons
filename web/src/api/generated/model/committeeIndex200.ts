 ...
 */
import type { CommitteeIndex200Meta } from "./committeeIndex200Meta";
import type { CommitteeMemberResource } from "./committeeMemberResource";

export type CommitteeIndex200 = {
  /** This page of the collection, in the collection's own order. */
  data: CommitteeMemberResource[];
  /** What you actually got. */
  meta: CommitteeIndex200Meta;
};
