 ...
 */
export type Problem412ResponseCode =
  (typeof Problem412ResponseCode)[keyof typeof Problem412ResponseCode];

export const Problem412ResponseCode = {
  if_match_failed: "if_match_failed",
} as const;
