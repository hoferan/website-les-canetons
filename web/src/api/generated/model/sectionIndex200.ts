 ...
 */
import type { SectionIndex200Meta } from "./sectionIndex200Meta";
import type { SectionResource } from "./sectionResource";

export type SectionIndex200 = {
  /** This page of the collection, in the collection's own order. */
  data: SectionResource[];
  /** What you actually got. */
  meta: SectionIndex200Meta;
};
