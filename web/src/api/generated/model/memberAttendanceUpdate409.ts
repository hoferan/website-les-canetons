 ...
 */
import type { MemberAttendanceUpdate409Code } from "./memberAttendanceUpdate409Code";
import type { MemberAttendanceUpdate409ErrorsItem } from "./memberAttendanceUpdate409ErrorsItem";

export type MemberAttendanceUpdate409 = {
  ...
  code: MemberAttendanceUpdate409Code;
  /** Always empty for this status; present so every problem has the same shape. */
  errors: MemberAttendanceUpdate409ErrorsItem[];
