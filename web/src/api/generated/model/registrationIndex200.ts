 ...
 */
import type { RegistrationIndex200Meta } from "./registrationIndex200Meta";
import type { RegistrationResource } from "./registrationResource";

export type RegistrationIndex200 = {
  /** This page of the collection, in the collection's own order. */
  data: RegistrationResource[];
  /** What you actually got. */
  meta: RegistrationIndex200Meta;
};
