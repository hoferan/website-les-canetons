 ...
 */
import type { HistoryEntryIndex200Meta } from "./historyEntryIndex200Meta";
import type { HistoryEntryResource } from "./historyEntryResource";

export type HistoryEntryIndex200 = {
  /** This page of the collection, in the collection's own order. */
  data: HistoryEntryResource[];
  /** What you actually got. */
  meta: HistoryEntryIndex200Meta;
};
