 ...
 */
import type { RegistrationOptionReplace409Code } from "./registrationOptionReplace409Code";
import type { RegistrationOptionReplace409ErrorsItem } from "./registrationOptionReplace409ErrorsItem";
...
export type RegistrationOptionReplace409 = {
  ...
  code: RegistrationOptionReplace409Code;
  /** Always empty for this status; present so every problem has the same shape. */
  errors: RegistrationOptionReplace409ErrorsItem[];
