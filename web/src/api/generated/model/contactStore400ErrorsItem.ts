 ...
 */
import type { ContactStore400ErrorsItemParams } from "./contactStore400ErrorsItemParams";
import type { ContactStore400ErrorsItemReason } from "./contactStore400ErrorsItemReason";

export type ContactStore400ErrorsItem = {
  /** The camelCase name of the rejected field, as it was submitted. */
  field: string;
  /** Stable machine token saying what is wrong with that field. */
  reason: ContactStore400ErrorsItemReason;
  params?: ContactStore400ErrorsItemParams;
};
