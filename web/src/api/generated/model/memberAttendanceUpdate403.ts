 ...
 */
import type { MemberAttendanceUpdate403Code } from "./memberAttendanceUpdate403Code";
import type { MemberAttendanceUpdate403ErrorsItem } from "./memberAttendanceUpdate403ErrorsItem";

export type MemberAttendanceUpdate403 = {
  ...
  code: MemberAttendanceUpdate403Code;
  /** Always empty for this status; present so every problem has the same shape. */
  errors: MemberAttendanceUpdate403ErrorsItem[];
