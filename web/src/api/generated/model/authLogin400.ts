 ...
 */
import type { AuthLogin400Code } from "./authLogin400Code";
import type { AuthLogin400ErrorsItem } from "./authLogin400ErrorsItem";
...
export type AuthLogin400 = {
  ...
  code: AuthLogin400Code;
  /** One entry per rejected field, first failure only. */
  errors: AuthLogin400ErrorsItem[];
