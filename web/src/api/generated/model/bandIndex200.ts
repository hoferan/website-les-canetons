 ...
 */
import type { BandIndex200Meta } from "./bandIndex200Meta";
import type { PublicSectionResource } from "./publicSectionResource";

export type BandIndex200 = {
  /** This page of the collection, in the collection's own order. */
  data: PublicSectionResource[];
  /** What you actually got. */
  meta: BandIndex200Meta;
};
