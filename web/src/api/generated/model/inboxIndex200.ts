 ...
 */
import type { InboxIndex200Meta } from "./inboxIndex200Meta";
import type { InboxItemResource } from "./inboxItemResource";

export type InboxIndex200 = {
  /** This page of the collection, in the collection's own order. */
  data: InboxItemResource[];
  /** What you actually got. */
  meta: InboxIndex200Meta;
};
