...
export type ContactMessageIndexHandled =
  (typeof ContactMessageIndexHandled)[keyof typeof ContactMessageIndexHandled];

export const ContactMessageIndexHandled = {
  NUMBER_0: "0",
  NUMBER_1: "1",
} as const;
