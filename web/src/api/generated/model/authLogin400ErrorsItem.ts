 ...
 */
import type { AuthLogin400ErrorsItemParams } from "./authLogin400ErrorsItemParams";
import type { AuthLogin400ErrorsItemReason } from "./authLogin400ErrorsItemReason";

export type AuthLogin400ErrorsItem = {
  /** The camelCase name of the rejected field, as it was submitted. */
  field: string;
  /** Stable machine token saying what is wrong with that field. */
  reason: AuthLogin400ErrorsItemReason;
  params?: AuthLogin400ErrorsItemParams;
};
