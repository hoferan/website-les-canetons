 ...
 */
import type { AttendanceIndex200Meta } from "./attendanceIndex200Meta";
import type { ChaseListEntryResource } from "./chaseListEntryResource";

export type AttendanceIndex200 = {
  /** This page of the collection, in the collection's own order. */
  data: ChaseListEntryResource[];
  /** What you actually got. */
  meta: AttendanceIndex200Meta;
};
