 ...
 */
export type HistoryEntryUpdate422Code =
  (typeof HistoryEntryUpdate422Code)[keyof typeof HistoryEntryUpdate422Code];

export const HistoryEntryUpdate422Code = {
  history_entry_empty: "history_entry_empty",
