 ...
 */
import type { StoreHistoryEntryRequestIcon } from "./storeHistoryEntryRequestIcon";
import type { StoreHistoryEntryRequestPrecision } from "./storeHistoryEntryRequestPrecision";
 ...
 */
export interface StoreHistoryEntryRequest {
  /** The day, or any day in the month or year, per `precision`. Stored truncated to it. */
  occurredOn: string;
  /** `year`, `month` or `day`. */
  precision: StoreHistoryEntryRequestPrecision;
  /**
   * @maxLength 120
   * @nullable
   */
