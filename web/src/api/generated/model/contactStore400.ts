 ...
 */
import type { ContactStore400Code } from "./contactStore400Code";
import type { ContactStore400ErrorsItem } from "./contactStore400ErrorsItem";

export type ContactStore400 = {
  ...
  code: ContactStore400Code;
  /** One entry per rejected field, first failure only. */
  errors: ContactStore400ErrorsItem[];
