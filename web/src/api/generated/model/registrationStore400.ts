 ...
 */
import type { RegistrationStore400Code } from "./registrationStore400Code";
import type { RegistrationStore400ErrorsItem } from "./registrationStore400ErrorsItem";

export type RegistrationStore400 = {
  ...
  code: RegistrationStore400Code;
  /** One entry per rejected field, first failure only. */
  errors: RegistrationStore400ErrorsItem[];
