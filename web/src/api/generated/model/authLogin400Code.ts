 ...
 */
export type AuthLogin400Code = (typeof AuthLogin400Code)[keyof typeof AuthLogin400Code];

export const AuthLogin400Code = {
  stateful_request_required: "stateful_request_required",
