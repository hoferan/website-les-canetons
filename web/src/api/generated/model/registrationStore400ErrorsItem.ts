 ...
 */
import type { RegistrationStore400ErrorsItemParams } from "./registrationStore400ErrorsItemParams";
import type { RegistrationStore400ErrorsItemReason } from "./registrationStore400ErrorsItemReason";

export type RegistrationStore400ErrorsItem = {
  /** The camelCase name of the rejected field, as it was submitted. */
  field: string;
  /** Stable machine token saying what is wrong with that field. */
  reason: RegistrationStore400ErrorsItemReason;
  params?: RegistrationStore400ErrorsItemParams;
};
