...
class MemberRolesTest extends TestCase
{
    ...
    public function test_it_replaces_a_members_roles(): void
    {
        ...
        $this->acting()->withHeaders($this->ifMatch('member', $target))->putJson("/api/v1/members/{$target->id}/roles", [
    ...
    public function test_removing_your_own_administration_is_refused(): void
    {
        ...
        $this->acting()->withHeaders($this->ifMatch('member', $this->actor))->putJson("/api/v1/members/{$this->actor->id}/roles", [
            'roleIds' => [],
    ...
    public function test_deleting_a_member_removes_them_and_ends_their_sessions(): void
    {
        ...
        $this->acting()->withHeaders($this->ifMatch('member', $target))->deleteJson("/api/v1/members/{$target->id}")->assertOk();
    ...
    public function test_deleting_yourself_is_refused(): void
    {
        ...
        $this->acting()->withHeaders($this->ifMatch('member', $this->actor))->deleteJson("/api/v1/members/{$this->actor->id}")->assertStatus(409)->assertJson(['code' => 'cannot_delete_self']);
    ...
    {
        $this->acting()->withHeaders($this->ifMatch('member', $this->actor))->deleteJson("/api/v1/members/{$this->actor->id}")->assertStatus(409)->assertJson(['code' => 'cannot_remove_last_administrator']);
    }
    ...
    public function test_a_player_can_do_neither(): void
    {
        ...
        $this->acting($player)->withHeaders($this->ifMatch('member', $target))->putJson("/api/v1/members/{$target->id}/roles", [
            'roleIds' => [],
        ])->assertStatus(403)->assertJson(['code' => 'access_denied']);

        $this->acting($player)->withHeaders($this->ifMatch('member', $target))->deleteJson("/api/v1/members/{$target->id}")->assertStatus(403)->assertJson(['code' => 'access_denied']);
