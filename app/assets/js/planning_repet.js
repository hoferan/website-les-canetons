...
function createDeleteElement(event) {
  ...
  // Lucide "trash-2" icon (vendored via lucide-static), matching the icons
  // used elsewhere in the app (see partials/navigation.php).
...
function createEditElement(event) {
  ...
  // Lucide "pencil" icon (vendored via lucide-static), matching the icons
  // used elsewhere in the app (see partials/navigation.php).
